...
PROTOBUF_NAMESPACE_OPEN
template<> ::mdrpc_pkg::RpcHeader* Arena::CreateMaybeMessage<::mdrpc_pkg::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace mdrpc_pkg {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:mdrpc_pkg.RpcHeader) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:mdrpc_pkg.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:mdrpc_pkg.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 service_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mdrpc_pkg.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:mdrpc_pkg.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:mdrpc_pkg.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mdrpc_pkg.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:mdrpc_pkg.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 method_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:mdrpc_pkg.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:mdrpc_pkg.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:mdrpc_pkg.RpcHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:mdrpc_pkg.RpcHeader.method_name)
}
...
inline uint32_t RpcHeader::args_size() const {
  // @@protoc_insertion_point(field_get:mdrpc_pkg.RpcHeader.args_size)
...
inline void RpcHeader::set_args_size(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:mdrpc_pkg.RpcHeader.args_size)
}
