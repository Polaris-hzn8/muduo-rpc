...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::mdrpc_pkg::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mdrpc_pkg::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::mdrpc_pkg::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::mdrpc_pkg::RpcHeader, args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::mdrpc_pkg::RpcHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::mdrpc_pkg::_RpcHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\tmdrpc_pkg\"I\n\tRpcHeade"
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:mdrpc_pkg.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:mdrpc_pkg.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:mdrpc_pkg.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:mdrpc_pkg.RpcHeader)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "mdrpc_pkg.RpcHeader.service_name"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "mdrpc_pkg.RpcHeader.method_name"));
        } else
          goto handle_unusual;
        continue;
      // uint32 args_size = 3;
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:mdrpc_pkg.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_service_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "mdrpc_pkg.RpcHeader.service_name");
  ...
  if (!this->_internal_method_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "mdrpc_pkg.RpcHeader.method_name");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mdrpc_pkg.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:mdrpc_pkg.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:mdrpc_pkg.RpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:mdrpc_pkg.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::mdrpc_pkg::RpcHeader*
Arena::CreateMaybeMessage< ::mdrpc_pkg::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mdrpc_pkg::RpcHeader >(arena);
}
